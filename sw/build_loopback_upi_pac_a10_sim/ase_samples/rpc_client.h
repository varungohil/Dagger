...
public:
    ...
    int loopback(const LoopBackArgs& args) {
        ...
        tx_ptr_casted->hdr.argl   = sizeof(LoopBackArgs);

        tx_ptr_casted->hdr.ctl.req_type    = rpc_request;
        tx_ptr_casted->hdr.ctl.update_flag = change_bit;

        *reinterpret_cast<LoopBackArgs*>(const_cast<uint8_t*>(tx_ptr_casted->argv)) = args;
        ...
        request.hdr.fn_id = 0;
        request.hdr.argl  = sizeof(LoopBackArgs);
        ...
        memcpy(request.argv, reinterpret_cast<const void*>(&args), sizeof(LoopBackArgs));
    ...
    int add(const AddArgs& args) {
        ...
        tx_ptr_casted->hdr.argl   = sizeof(AddArgs);

        tx_ptr_casted->hdr.ctl.req_type    = rpc_request;
        tx_ptr_casted->hdr.ctl.update_flag = change_bit;

        *reinterpret_cast<AddArgs*>(const_cast<uint8_t*>(tx_ptr_casted->argv)) = args;
        ...
        request.hdr.fn_id = 1;
        request.hdr.argl  = sizeof(AddArgs);
        ...
        memcpy(request.argv, reinterpret_cast<const void*>(&args), sizeof(AddArgs));
