...
public:
    ...
    virtual void operator()(const CallHandler handler,
        ...
        switch (rpc_in->hdr.fn_id) {
            case 0: {
                ret_code = (*reinterpret_cast<RpcRetCode(*)(CallHandler, GetRequest, GetResponse*)>(rpc_fn_ptr_[0]))(handler, *reinterpret_cast<const GetRequest*>(rpc_in->argv), reinterpret_cast<GetResponse*>(ret_buff));
                ret_size = sizeof(GetResponse);
                break;
            }
        }
